...
describe "ProductCustomDomainScenario", type: :system, js: true do
  ...
  context "when the URL includes the product permalink" do
    it "successfully purchases the linked product" do
  ...
  context "when there is a discount code" do
    ...
    it "applies the discount code when the URL contains both the product permalink and the discount code" do
